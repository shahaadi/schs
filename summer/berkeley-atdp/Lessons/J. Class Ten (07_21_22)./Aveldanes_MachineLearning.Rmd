...
Here the learning function *f* can be written $flipper\_length\_mm = f(bill\_length\_mm, island, bodymass) + \epsilon$
...
$flipper\_length\_mm = f(bill\_length\_mm, island, bodymass) + \epsilon$
*Write your answer between these lines* 
...
regression, could be classification if the scores are not ordered
